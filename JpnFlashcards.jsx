    ...
    <div className="tc-root">
      ...
      <div className="tc-shell">
        ...
        {!ready ? (
          ...
          <Quizzes cards={cards} loadQuizzes={loadQuizzes} logDay={logDay} />
        ) : tab === "scripts" ? (
          ...
          <Browse cards={cards} onRemove={removeCard} onClear={clearAll} onRestore={restoreDeck}
                  syncStateNow={syncStateNow} watchSyncState={watchSyncState} pushCloudNow={pushCloudNow} hasSyncPending={hasSyncPending}
                  googleEmailNow={googleEmailNow} authStateNow={authStateNow} watchAuthState={watchAuthState}
                  renderGoogleButton={renderGoogleButton} initGoogleAuth={initGoogleAuth} signOutGoogle={signOutGoogle}
                  SYNC_UI={SYNC_UI} SEED={SEED} uid={uid} setDaysCache={(cur) => { _days = cur; }} />
        )}
      </div>
...
/* Every control is labelled in English first with the Japanese underneath. */
