...
// drinks job to
const CLASSMATE = ["たなか", "やまだ", "スミス", "ジョンソン", "ブラウン"];
...
export const SITUATIONS = [
  {
    ...
    questions: [
      { q: "パーティーはいつですか。", r: "パーティーはいつですか。", en: "When is the party?",
        a: (p) => `${p.flyer.monthDayJa}です。`, g: "month + day — the 〜がつ and 〜にち readings" },
      { q: (p) => `${p.flyer.wrongDowJa}ですね。`, r: (p) => `${p.flyer.wrongDowJa}ですね。`,
        ...
        g: "polite correction with the negative — じゃなかったですか", star: true },
      { q: "なんじからなんじまでですか。", r: "なんじからなんじまでですか。", en: "From what time to what time?",
        a: (p) => `${p.flyer.timeJa}です。`, g: "〜から〜まで" },
      { q: "どこでしますか。", r: "どこでしますか。", en: "Where is it?",
        a: (p) => `${p.flyer.room.read}でします。`, g: "place + で" },
      { q: "フラックはなんですか。", r: "フラックはなんですか。", en: "What is FLAC? — SAY THE WHOLE PHRASE",
        a: (p) => `${p.flyer.room.full}です。`, g: "the full katakana name, said cleanly", star: true },
      { q: "フラックはどこにありますか。", r: "フラックはどこにありますか。", en: "Where is FLAC?",
        a: (p) => p.flyer.room.whereRead, g: "〜にあります + place" },
    ],
  },
  {
    id: "s2",
    ...
    questions: [
      { q: (p) => `${p.classmate}さんがちらしをつくりましたね。`, r: (p) => `${p.classmate}さんがちらしをつくりましたね。`,
        en: "“[Name] made the flier, right?” — NO, YOU DID",
        a: () => "いいえ、わたしがつくりました。", g: "が marks who did it — the point of the turn", star: true },
      { q: "いつつくりましたか。", r: "いつつくりましたか。", en: "When did you make it?",
        a: (p) => `${p.made.day}につくりました。`, g: "past 〜ました + a time word" },
      { q: "どのくらいかかりましたか。たいへんでしたか。", r: "どのくらいかかりましたか。たいへんでしたか。",
        en: "How long did it take? Was it tough?",
        a: (p) => `${minutesReading(p.made.mins)}ぐらいかかりました。ちょっとたいへんでした。`,
        g: "ぐらい for approximate + たいへんでした" },
      { q: "なんまいコピーしましたか。", r: "なんまいコピーしましたか。", en: "How many copies did you make?",
        a: (p) => `${p.receipt.copiesJa}コピーしました。`, g: "〜まい counter — read it off the receipt" },
      { q: "たかくなかったですか。", r: "たかくなかったですか。", en: "Wasn't it expensive?",
        a: (p) => `そうですね、${p.receipt.priceJa}でしたから、ちょっとたかかったです。`,
        g: "DON'T say はい here — to たかくなかったですか, はい means “right, it wasn't”. そうですね dodges it." },
      { q: null, r: null,
        en: "NOW YOU START — propose the pizza place with 〜でもいいですか",
        a: (p) => `たべものですが、${p.budget.place}のピザでもいいですか。`,
        g: "YOU INITIATE · noun + でもいいですか (asking permission)", initiate: true, star: true },
      { q: "ピザはなんまいかいますか。", r: "ピザはなんまいかいますか。", en: "How many pizzas are you buying?",
        a: (p) => `${p.budget.pizzasJa}かいます。`, g: "〜まい for pizzas" },
      { q: "だれがかいますか。", r: "だれがかいますか。", en: "Who is ordering?",
        a: () => "わたしがかいます。", g: "が again — I'm the one who does it" },
      { q: null, r: null,
        en: "NOW YOU START — ask them to buy the drinks and refreshments",
        a: (p) => `${p.classmate}さん、のみものとたべものをかってください。`,
  ...
  },
  {
    ...
    questions: [
      { q: "せんこうはなんですか。", r: "せんこうはなんですか。", en: "What's your major?",
        a: () => "せんこうはビジネスです。", g: "せんこう — swap in your real major" },
      { q: "きょうはなにをしましたか。", r: "きょうはなにをしましたか。", en: "What did you do today?",
        a: () => "あさごはんをたべて、じゅぎょうにいって、べんきょうしました。", g: "〜て to chain actions, then past" },
      { q: "あしたはなにをしますか。", r: "あしたはなにをしますか。", en: "What are you doing tomorrow?",
        a: () => "あしたはにほんごをべんきょうして、ともだちにあいます。", g: "same chain, non-past" },
      { q: "どちらからきましたか。", r: "どちらからきましたか。", en: "Where are you from?",
        a: () => "ユタのプロボからきました。", g: "どちら (polite どこ) + 〜からきました" },
      { q: "こんがっきはなんのじゅぎょうをとっていますか。", r: "こんがっきはなんのじゅぎょうをとっていますか。",
        en: "What classes are you taking this semester?",
        a: () => "にほんごとすうがくのじゅぎょうをとっています。", g: "なんの + じゅぎょう — なんの, not なにが / なにを" },
      { q: "じゅぎょうはむずかしいですか。", r: "じゅぎょうはむずかしいですか。", en: "Are your classes hard?",
        a: () => "にほんごのじゅぎょうはちょっとむずかしいです。でも、おもしろいです。",
        g: "い-adjective, then でも to add the other half" },
      { q: "せんがっきはどうでしたか。", r: "せんがっきはどうでしたか。", en: "How was last semester?",
        a: () => "せんがっきのじゅぎょうはやさしかったです。でも、こんがっきはちょっとたいへんです。",
        g: "past adjective やさしかった — last semester vs this one" },
    ],
  },
];
...
/* The grammar checklist from the study guide, kept where it can be read a minute before
   ...
   excuse to use them. Kana only, like everything else in this tab. */
export const CHECKLIST = [
  { k: "Time words", v: "days, months, years, today, tomorrow, this/last/next week, semester" },
  { k: "Polite correction", v: "じゃなかったですか — the moment they get the weekday wrong" },
  { k: "Particles", v: "が・は・を・に・も — が for who did it, は for the topic" },
  { k: "Classifiers", v: "〜まい for copies and pizzas, 〜じかん, 〜かげつ, 〜ねん" },
  { k: "ぐらい", v: "approximately — for how long it took and how much it cost" },
  { k: "て forms", v: "おおきくて / きょうしつで / あるいて — adjectives, nouns and verbs each differ" },
  { k: "Past vs present", v: "ます→ました, です→でした, たかい→たかかった" },
  { k: "Question words", v: "どの・なに・どこ／どちら・いつ — and なんの vs なにが / なにを / なにに" },
  { k: "English words", v: "ジェイエフエスビー, フラック — say them as Japanese, not English" },
];
